...
const imagensCatalogo = new Array(
  "./catalogo/page_1.jpg",
  "./catalogo/page_2.jpg",
  "./catalogo/page_3.jpg",
  "./catalogo/page_4.jpg",
...
const imgLeitura = document.getElementById('img-leitura');

// Ativa o Modo Leitura
btnLeitura.addEventListener('click', () => {
  // Pega o índice da página atual (0, 1, 2...)
  const paginaAtual = pageFlip.getCurrentPageIndex();
  
  // Injeta a imagem correta na tag <img>
  imgLeitura.src = imagensCatalogo[paginaAtual];
  
  // Mostra o overlay removendo a classe 'hidden' do Tailwind
  overlayLeitura.classList.remove('hidden');
  overlayLeitura.classList.add('flex');
  
  // Trava o scroll do body para o usuário não rolar o site por trás do modal
...
btnFechar.addEventListener('click', () => {
  ...
  // Libera a memória limpando o source
  imgLeitura.src = ''; 
