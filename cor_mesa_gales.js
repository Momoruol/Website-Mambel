...
function mudar_cor_mesa_gales(div){
  ...
  const img = ['../imagens/Criado Mudo Gales Branco - Ambientada.jpg','../imagens/Criado Mudo Gales Nogueira.Areia - Ambientada.jpg']
  if(local.classList.contains('active')){
    return
    }else{
        const mesa_gales = new Array(mesa_gales_cor_1,mesa_gales_cor_2)
